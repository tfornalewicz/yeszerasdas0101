...
function onKill(creature, target)
    ...
    for pid, _ in pairs(targetMonster:getDamageMap()) do
		...
		attackerPlayer:setStorageValue(Storage.Ferumbras.PlagirathTp, os.time() + 3 * 60)
		attackerPlayer:setStorageValue(Storage.Ferumbras.Plagirath48, os.time() + 24 * 3600)
