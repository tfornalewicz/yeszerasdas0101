...
local config = {
	[5907]	=	{NAME = 'Bear',					ID = 3,		TYPE = TYPE_MONSTER,	CHANCE = 30,	FAIL_MSG = { {1, 'The bear ran away.'}, {2, 'Oh no! The slingshot broke.'}, {3, 'The bear is trying to hit you with its claws.'} },SUCCESS_MSG = 'You have tamed the bear.'},
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	if targetMonster ~= nil and mount.TYPE == TYPE_MONSTER then
		...
		if mount.NAME == targetMonster:getName() then
			...
			player:addAchievementProgress(37, 5)
			player:addAchievement(7)
