local config = {
	...
	[23574] = { -- glooth bag
		chances = {
			{from = 1, to = 1875, itemId = 23529, count = 2},
			{from = 1876, to = 3419, itemId = 23554},
			{from = 3420, to = 4935, itemId = 23549, count = 2},
			{from = 4936, to = 6400, itemId = 23551, count = 2},
			{from = 6401, to = 7833, itemId = 23550, count = 2},
			{from = 7834, to = 8467, itemId = 23666},
			{from = 8468, to = 8981, itemId = 23514, count = 10},
			{from = 8982, to = 9476, itemId = 23515, count = 10},
			{from = 9477, to = 9930, itemId = 23517, count = 10},
			{from = 9931, to = 10001, itemId = 23557}
		},
		effect = CONST_ME_HITBYPOISON
	},
