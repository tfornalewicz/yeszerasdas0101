...
local storage, duration = 1.4, 0.8
	...
	NpcHandler = {
		...
		messages = {
			...
			[MESSAGE_FAREWELL] = "Zegnaj, |PLAYERNAME|.",
			[MESSAGE_BUY] = "Czy chcesz kupic |ITEMCOUNT| |ITEMNAME| za |TOTALCOST| zlotych monet?",
			[MESSAGE_ONBUY] = "Prosze.",
			[MESSAGE_BOUGHT] = "Kupiono |ITEMCOUNT|x |ITEMNAME| za |TOTALCOST| zlota.",
			[MESSAGE_SELL] = "Czy chcesz sprzedac |ITEMCOUNT| |ITEMNAME| za |TOTALCOST| zlotych monet?",
			[MESSAGE_ONSELL] = "Prosze, |TOTALCOST| zlota.",
			[MESSAGE_SOLD] = "Sprzedano |ITEMCOUNT|x |ITEMNAME| za |TOTALCOST| zlota.",
			[MESSAGE_MISSINGMONEY] = "Nie masz wystarczajaco duzo kasy.",
			[MESSAGE_NEEDMONEY] = "Nie masz wystarczajaco duzo kasy.",
			[MESSAGE_MISSINGITEM] = "Nie masz tak wiele.",
			[MESSAGE_NEEDITEM] = "Nie masz tego.",
			[MESSAGE_NEEDSPACE] = "Nie udzwigniesz tego.",
			[MESSAGE_NEEDMORESPACE] = "Nie udzwigniesz tego wszystkiego.",
			[MESSAGE_IDLETIMEOUT] = "Nara.",
			[MESSAGE_WALKAWAY] = "Nara.",
			[MESSAGE_DECLINE] = "To nie.",
			[MESSAGE_SENDTRADE] = "Jasne, wybieraj.",
			[MESSAGE_NOSHOP] = "Ja nic nie sprzedaje.",
			[MESSAGE_ONCLOSESHOP] = "Dzieki, wroc jak bedziesz czegos potrzebowal.",
			[MESSAGE_ALREADYFOCUSED] = "|PLAYERNAME|, juz z Toba rozmawiam.",
			[MESSAGE_WALKAWAY_MALE] = "Nara.",
			[MESSAGE_WALKAWAY_FEMALE] = "Nara."
		}
	}
