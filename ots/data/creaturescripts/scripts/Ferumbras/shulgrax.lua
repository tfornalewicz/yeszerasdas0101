...
function onKill(creature, target)
    ...
    for pid, _ in pairs(targetMonster:getDamageMap()) do
		...
		attackerPlayer:setStorageValue(Storage.Ferumbras.ShulgraxTp, os.time() + 3 * 60)
		attackerPlayer:setStorageValue(Storage.Ferumbras.Shulgrax48, os.time() + 24 * 3600)
