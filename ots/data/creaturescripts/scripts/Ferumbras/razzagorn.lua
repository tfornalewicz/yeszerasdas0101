...
function onKill(creature, target)
    ...
    for pid, _ in pairs(targetMonster:getDamageMap()) do
		...
		attackerPlayer:setStorageValue(Storage.Ferumbras.RazzagornTp, os.time() + 3 * 60)
		attackerPlayer:setStorageValue(Storage.Ferumbras.Razzagorn48, os.time() + 24 * 3600)
