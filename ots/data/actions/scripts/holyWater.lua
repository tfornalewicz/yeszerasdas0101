local doorPosition = Position(32260, 32791, 7) 	-- koordy drzwi co sie zamkna 
local shadowNexusPosition = Position(33115, 31702, 12) -- magic wall na nexusie
local effectPositions = {
	Position(33113, 31702, 12), --lewa kosc
	Position(33116, 31702, 12) -- prawa kosc
}
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	elseif target.actionid == 2003 then
		...
		local doorItem = Tile(doorPosition):getItemById(8697) -- id otwartych drzwi
		if doorItem then
			doorItem:transform(8696) -- id zamknietych drzwi
		end
