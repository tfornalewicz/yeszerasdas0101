local destination = {
	[4121] = {position = Position(7328, 1305, 8), storageValue = 1, needCrystal = true}, --{x = 7328, y = 1305, z = 8}
	...
	[3215] = {position = Position(32369, 32241, 7), storageValue = 1, needCrystal = true}, -- MIASTA
