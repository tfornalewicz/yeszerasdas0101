local teleports = {
	...
	[2151] = {text = 'Entering the Crystal Caves.', bossStorage = 200, newPos = Position(6675, 1878, 12), storage = 1}, -- from ushuriel ward {x = 6675, y = 1878, z = 12}
	...
	[2157] = {text = 'Entering the Blood Halls.', bossStorage = 201, newPos = Position(6978, 1709, 13), storage = 2}, -- from zugurosh ward {x = 6978, y = 1709, z = 13}
	...
	[2162] = {text = 'Entering the Vats.', bossStorage = 202, newPos = Position(6759, 1878, 11), storage = 3}, -- from madareth ward {x = 6759, y = 1878, z = 11}
	...
	[2168] = {text = 'Entering the Arcanum.', bossStorage = 203, newPos = Position(6687, 1922, 12), storage = 4}, -- from demon forge {x = 6687, y = 1922, z = 12}
	...
	[2174] = {text = 'Entering the Hive.', bossStorage = 204, newPos = Position(6806, 1782, 11), storage = 5}, -- from annihilon ward {x = 6803, y = 1799, z = 10}
	...
	[2178] = {text = 'Entering the Shadow Nexus. Abandon all Hope.', bossStorage = 205, newPos = Position(6716, 1778, 11), storage = 6}, -- from hellgorak ward {x = 6716, y = 1778, z = 11}
